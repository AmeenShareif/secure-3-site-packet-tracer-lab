...
This page is a quick status check for the repo.
...
| Portfolio write-up | Included | The summary is written in a student voice. |

## Repository note

The repo is organized like a finished class project, so the docs, configs, screenshots, and write-up all point to the same lab.
